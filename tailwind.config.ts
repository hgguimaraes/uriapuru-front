...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'background-unit': "url('/assets/images/all-img/background-unit.png')",
        'front-pdf': "url('/assets/images/all-img/side-bg.svg')",
        'top-pdf': "url('/assets/images/all-img/top-pdf.svg')"
      }
    },
  },
  plugins: [],
